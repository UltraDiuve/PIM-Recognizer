\part{Les objectifs de ce projet}
    ...
    \chapter{Présentation rapide des données relatives au cas d'usage}
        ...
        \section{Pièces jointes}
            ...
            Les fiches techniques fournisseur sont des pièces jointes qui sont collectées par la branche \'{E}piSaveurs depuis la mise en place du logiciel de gestion historique GIP (cf. la description de ce système en annexe \mref{GIP}), et il s'agit d'une données obligatoire dans le PIM également.
