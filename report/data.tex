\part{Les données}
    ...
    \chapter{Les données utilisables, issues du PIM}
        ...
        Des représentations de ces données sont présentées aux \reftable{tbl:exemple_idt}, \reftable{tbl:desc_idt}.
        Ajouter un tableau d'exemple avec ces données, en distingant sous forme de multiples tableaux (la logistique à part, etc...)
        Faire un notebook pour cela.
